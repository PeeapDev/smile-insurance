...
export default function NewCompanyMotorPolicyPage() {
  ...
  function estimatePremium(cov: "Comprehensive" | "Third-Party" | "Fire & Theft") {
    const base = 140 // slightly different base for company policies as a demo
    if (cov === "Comprehensive") return base + 110
    if (cov === "Fire & Theft") return base + 55
    return base
  }
  ...
  function createPolicy() {
    ...
    const policyNumber = `CMTR-${Math.random().toString().slice(2,8).toUpperCase()}`
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>We’ll generate a quote and create the company policy.</CardDescription>
        </CardHeader>
        <CardContent>
